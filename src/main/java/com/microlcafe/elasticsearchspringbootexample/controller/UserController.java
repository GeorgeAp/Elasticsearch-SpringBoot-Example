package com.microlcafe.elasticsearchspringbootexample.controller;

import com.microlcafe.elasticsearchspringbootexample.domain.User;
    ...
    public String create(User user) throws IOException {
        IndexResponse response = client.prepareIndex("users", "employee", user.getUserId())
                .setSource(jsonBuilder()
                        ...
                        .field("userSettings", user.getUserSetting())
                        .endObject()
                )
                .get();
